...
public class ListExecute implements IBoardService
{
	...
	public void execute(Model model)
	{
		...
		int blockSize = Integer.parseInt(EnvFileReader.getValue("SpringBbsInit.properties", "springBoard.blockPage"));
...
//			virtualNum = totalRecordCount--;
		...
		String pagingImg = PagingUtil.pagingImg(totalRecordCount, pageSize, blockSize, nowPage, 
